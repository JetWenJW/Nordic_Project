...
static void advertising_init(void)
{
  ...
  /* Create Variable for Maunf Data */
  uint8_t vendors_adv_data[6] = {0x43, 0x54, 0x87, 0x98, 0x76, 0x32};
  ble_advdata_manuf_data_t m_spec_data;
  
  /* Initial the Value of Maunf Data */
  ...
  init.advdata.p_manuf_specific_data  = &m_spec_data;       /* Assign Maunf Specific Data */
