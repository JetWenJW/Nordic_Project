...
#define DEVICE_NAME               "Jet_BLE_Firmware_Engineering Project"
...
static void advertising_init(void)
{
  ...
  init.advdata.short_name_len       = 7;            /* Choose Short Name must set short Length */
...
static void ble_stack_init(void)
{
  ...
  NRF_SDH_BLE_OBSERVER(m_ble_observer, APP_BLE_OBSERVER_PRIO, ble_evt_handler, NULL);   /* Assign BLE Event Handler */
}
